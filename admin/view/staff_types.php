...
$menu->settings = array(
	...
	'label_singular'                => __( 'Staff Type', 'soccer-engine-lite' ),
	'label_plural'                  => __( 'Staff Types', 'soccer-engine-lite' ),
	'label_create_new_item'         => __( 'Create New Staff Type', 'soccer-engine-lite' ),
	'label_edit_item'               => __( 'Edit Staff Type', 'soccer-engine-lite' ),
	'label_add_item'                => __( 'Add Staff Type', 'soccer-engine-lite' ),
	'label_update_item'             => __( 'Update Staff Type', 'soccer-engine-lite' ),
	...
	'label_item_deleted'            => __( 'The staff type has been successfully deleted.', 'soccer-engine-lite' ),
	'label_item_added'              => __( 'The staff type has been successfully added.', 'soccer-engine-lite' ),
	'label_item_updated'            => __( 'The staff type has been successfully updated', 'soccer-engine-lite' ),
	...
	'pagination_columns'            => array(
		array(
			...
			'tooltip'         => __( 'The ID of the staff type.', 'soccer-engine-lite' ),
		),
		array(
			'database_column' => 'name',
			'label'           => __( 'Name', 'soccer-engine-lite' ),
			'tooltip'         => __( 'The name of the staff type.', 'soccer-engine-lite' ),
		),
		array(
			'database_column' => 'description',
			'label'           => __( 'Description', 'soccer-engine-lite' ),
			'tooltip'         => __( 'The description of the staff type.', 'soccer-engine-lite' ),
		),
	),
