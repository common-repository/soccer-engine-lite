...
$menu->settings = array(
	...
	'label_singular'                => __( 'Unavailable Player Type', 'soccer-engine-lite' ),
	'label_plural'                  => __( 'Unavailable Player Types', 'soccer-engine-lite' ),
	'label_create_new_item'         => __( 'Create New Unavailable Player Type', 'soccer-engine-lite' ),
	'label_edit_item'               => __( 'Edit Unavailable Player Type', 'soccer-engine-lite' ),
	'label_add_item'                => __( 'Add Unavailable Player Type', 'soccer-engine-lite' ),
	'label_update_item'             => __( 'Update Unavailable Player Type', 'soccer-engine-lite' ),
	...
	'label_item_deleted'            => __( 'The unavailable player type has been successfully deleted.', 'soccer-engine-lite' ),
	'label_item_added'              => __( 'The unavailable player type has been successfully added.', 'soccer-engine-lite' ),
	'label_item_updated'            => __( 'The unavailable player type has been successfully updated', 'soccer-engine-lite' ),
	...
	'pagination_columns'            => array(
		array(
			...
			'tooltip'         => __( 'The ID of the unavailable player type.', 'soccer-engine-lite' ),
		),
		array(
			'database_column' => 'name',
			'label'           => __( 'Name', 'soccer-engine-lite' ),
			'tooltip'         => __( 'The name of the unavailable player type.', 'soccer-engine-lite' ),
		),
		array(
			'database_column' => 'description',
			'label'           => __( 'Description', 'soccer-engine-lite' ),
			'tooltip'         => __( 'The description of the unavailable player type.', 'soccer-engine-lite' ),
		),
	),
