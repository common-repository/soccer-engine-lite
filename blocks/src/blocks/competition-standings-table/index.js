...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const columnsData = {
      action: 'daextsoenl_get_columns_competition_standings_table',
    ...
    return [
      <div className="daextsoenl-block-image">{__('Competition Standings Table', 'soccer-engine-lite')}</div>,
 ...
 */
registerBlockType('daextsoenl/competition-standings-table', {
  title: __('Competition Standings Table', 'soccer-engine-lite'),
  icon: BallIcon,
  category: 'daextsoenl-soccer-engine',
  keywords: [
    __('competition standings table', 'soccer-engine-lite'),
