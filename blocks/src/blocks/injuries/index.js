...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const injuryTypeIdData = {
      action: 'daextsoenl_get_injury_type_list',
      attributeName: 'injuryTypeId',
      title: __('Injury Type', 'soccer-engine-lite'),
    };

    const columnsData = {
      action: 'daextsoenl_get_columns_injuries',
    ...
    return [
      <div className="daextsoenl-block-image">{__('Injuries', 'soccer-engine-lite')}</div>,
 ...
 */
registerBlockType('daextsoenl/injuries', {
  title: __('Injuries', 'soccer-engine-lite'),
  icon: BallIcon,
  category: 'daextsoenl-soccer-engine',
  keywords: [
    __('injuries', 'soccer-engine-lite'),
