...
class BlockEdit extends Component {
  ...
  render() {
    ...
    return [
      <div className="daextsoenl-block-image">{__('Match Commentary', 'soccer-engine-lite')}</div>,
 ...
 */
registerBlockType('daextsoenl/match-commentary', {
  title: __('Match Commentary', 'soccer-engine-lite'),
  icon: BallIcon,
  category: 'daextsoenl-soccer-engine',
  keywords: [
    __('match commentary', 'soccer-engine-lite'),
