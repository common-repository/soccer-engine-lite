...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const columnsData = {
      action: 'daextsoenl_get_columns_match_lineup',
    ...
    return [
      <div className="daextsoenl-block-image">{__('Match Lineup', 'soccer-engine-lite')}</div>,
 ...
 */
registerBlockType('daextsoenl/match-lineup', {
  title: __('Match Lineup', 'soccer-engine-lite'),
  icon: BallIcon,
  category: 'daextsoenl-soccer-engine',
  keywords: [
    __('match lineup', 'soccer-engine-lite'),
