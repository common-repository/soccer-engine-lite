...
class BlockEdit extends Component {
  ...
  render() {
    ...
    return [
      <div className="daextsoenl-block-image">{__('Match Visual Lineup', 'soccer-engine-lite')}</div>,
 ...
 */
registerBlockType('daextsoenl/match-visual-lineup', {
  title: __('Match Visual Lineup', 'soccer-engine-lite'),
  icon: BallIcon,
  category: 'daextsoenl-soccer-engine',
  keywords: [
    __('match visual lineup', 'soccer-engine-lite'),
