...
class BlockEdit extends Component {
  ...
  constructor(props) {
    ...
    if(typeof this.props.attributes.columns === 'undefined'){
      this.props.setAttributes({columns: ['staff', 'date_of_birth', 'citizenship']});
    }
  ...
  render() {
    ...
    const columnsData = {
      action: 'daextsoenl_get_columns_squad_staff',
    ...
    return [
      <div className="daextsoenl-block-image">{__('Squad Staff', 'soccer-engine-lite')}</div>,
 ...
 */
registerBlockType('daextsoenl/squad-staff', {
  title: __('Squad Staff', 'soccer-engine-lite'),
  icon: BallIcon,
  category: 'daextsoenl-soccer-engine',
  keywords: [
    __('squad staff', 'soccer-engine-lite'),
