...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const columnsData = {
      action: 'daextsoenl_get_columns_squad_substitutions',
    ...
    return [
      <div className="daextsoenl-block-image">{__('Squad Substitutions', 'soccer-engine-lite')}</div>,
 ...
 */
registerBlockType('daextsoenl/squad-substitutions', {
  title: __('Squad Substitutions', 'soccer-engine-lite'),
  icon: BallIcon,
  category: 'daextsoenl-soccer-engine',
  keywords: [
    __('squad substitutions', 'soccer-engine-lite'),
