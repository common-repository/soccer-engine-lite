...
class BlockEdit extends Component {
  ...
  render() {
    ...
    const staffAwardTypeData = {
      action: 'daextsoenl_get_staff_award_type_list',
      attributeName: 'staffAwardTypeId',
      title: __('Staff Award Type', 'soccer-engine-lite'),
    };

    const columnsData = {
      action: 'daextsoenl_get_columns_staff_awards',
    ...
    return [
      <div className="daextsoenl-block-image">{__('Staff Awards', 'soccer-engine-lite')}</div>,
 ...
 */
registerBlockType('daextsoenl/staff-awards', {
  title: __('Staff Awards', 'soccer-engine-lite'),
  icon: BallIcon,
